...
import jp.co.soramitsu.fearless_utils.decoratable_api.derive.staking.chill
...
import jp.co.soramitsu.fearless_utils.decoratable_api.derive.staking.historyDepth
import jp.co.soramitsu.fearless_utils.decoratable_api.derive.staking.staking
import jp.co.soramitsu.fearless_utils.decoratable_api.derive.staking.unbond
import jp.co.soramitsu.fearless_utils.decoratable_api.derive.utility.batch
import jp.co.soramitsu.fearless_utils.decoratable_api.derive.utility.utility
...
class TestApi {
    ...
    fun test() = runBlocking {
        ...
        api.tx.utility.batch(
            ...
            api.tx.staking.unbond(123.toBigInteger())
        ).sign()
