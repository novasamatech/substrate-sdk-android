...
internal object Sr25519SubstrateKeypairFactory : KeypairFactory<Sr25519Keypair> {
    override fun deriveFromSeed(seed: ByteArray): Sr25519Keypair {
        val keypairBytes = io.novasama.substrate_sdk_android.encrypt.Sr25519.keypairFromSeed(seed)
    ...
    private fun deriveSr25519SoftKeypair(
        ...
        val newKeypairbytes = io.novasama.substrate_sdk_android.encrypt.Sr25519.deriveKeypairSoft(keypair, chaincode)
    ...
    private fun deriveSr25519HardKeypair(
        ...
        val keypair = previousKeypair.privateKey + previousKeypair.nonce + previousKeypair.publicKey
        val newKeypairbytes = io.novasama.substrate_sdk_android.encrypt.Sr25519.deriveKeypairHard(keypair, chaincode)
